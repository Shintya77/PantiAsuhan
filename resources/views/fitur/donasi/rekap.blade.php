  ...
  <div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            ...
            <h6 class="text-black">Terima kasih, kepada saudara - saudara yang telah berdonasi kepada kami. Semoga donasi yang anda berikan bermanfaat bagi saudara kita yang membutuhkan</h6>
        </div>
